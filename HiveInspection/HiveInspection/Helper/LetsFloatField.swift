...
public class LetsFloatField: UITextField {
    ...
    @IBInspectable open var placeHolderColor : UIColor = UIColor.lightGray{
        didSet {
            if #available(iOS 13.0, *) {
                let placeholderString = NSAttributedString.init(string: self.placeholder ?? "" , attributes: [NSAttributedString.Key.foregroundColor : placeHolderColor, NSAttributedString.Key.font : UIFont(name: "SFCompactRounded-Heavy", size: 13.0)!])
    ...
    public var floatingLabelShowAnimationDuration           = 0.2
    ...
    fileprivate func insetRectForBounds(rect:CGRect) -> CGRect {
        ...
        guard lblFloatPlaceholder.text != nil else {
    ...
    override public func layoutSubviews() {
        ...
        lblFloatPlaceholder.textColor = placeHolderColor
