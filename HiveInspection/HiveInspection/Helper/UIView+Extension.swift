...
public extension UIView {
    ...
    func hideView(_ hidden: Bool, byAttribute attribute: NSLayoutConstraint.Attribute) {
    ...
    func sizeToSubviews() {
        self.updateSizes()
        let fittingSize: CGSize = self.systemLayoutSizeFitting(UIView.layoutFittingCompressedSize)
