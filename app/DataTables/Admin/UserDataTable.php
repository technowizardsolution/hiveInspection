    ...
    public function dataTable($query)
    {
        ...
        return datatables($query)
            ->addColumn('action', function ($user) {
                ...
                //     $view = '<a class="label label-primary badge badge-light-primary" href="' . route('users.show', $id) . '"  title="View"><i class="fa fa-eye"></i>&nbsp</a>';
                // } else {
                //     $view = '';
                // }

                if (auth()->user()->can('user-edit')) {
                    $edit = '<a class="label label-success badge badge-light-success" href="' . route('users.edit', $id) . '"  title="Update"><i class="fa fa-edit"></i>&nbsp</a>';
            ...
            ->editColumn('last_login_at', function ($user) {
                return GlobalHelper::getFormattedDate($user->last_login_at);
            })
