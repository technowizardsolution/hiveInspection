                ...
                <div class="row">
                    <div class="col-md-12 col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="" id="dataForm" role="form" action="{{route('roles.store')}}" method="post" enctype="multipart/form-data" >
                                    {{ csrf_field() }}
                                    <div class="col-sm-12">
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-body">
                                                <div class="form-group {{ $errors->has('name') ? ' has-error' : '' }}">
                                                    ...
                                                    <div class=" jointbox">
                                                        <input type="text" class="form-control" id="name" name="name" placeholder="Role Name in lower case" value="{{old('name')}}"/>
                                                        @if ($errors->has('name'))
                                                            ...
                                                            <div class="col-sm-12">
                                                                ...
                                                                @foreach($permissions as $row)
                                                                    <div class="col-lg-4 col-md-3 col-sm-3">
                                                                        <label>{{ Form::checkbox('permission[]', $row->id, false, array('class' => 'name minimal mr-2 all '.$key.'')) }}
                                                                            {{ $row->name }}
                                                                        </label>
                                                                    </div>
                                                                @endforeach
