@section('title') Inspections | @endsection
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Inspections</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item "><a href="{{url('admin/dashboard')}}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item active">Inspections
                                </li>
                            </ol>
                        </div>
                    </div>
                  ...
                  <div class="col-12">
                      <div class="card">
                          ...
                          <div class="card-datatable datatable-row-remove">
                              {!! $html->table(['class' => 'table  dt-complex-header table-bordered','id'=>'InspectionDataTable']) !!}
                          </div>
                      </div>
                  </div>
                </div>
  ...
  function deleteConfirm(id){
    ...
    bootbox.confirm({
      ...
      callback: function(result){
        if (result){
          $.ajax({
            url: SITE_URL + '/admin/inspection/'+id,
            type: "DELETE",
            cache: false,
            ...
            success: function (data, textStatus, xhr) {
              ...
              {
                  toastr.warning('Inspection Deleted !!');
                  $('#InspectionDataTable').DataTable().ajax.reload(null, false);
              }
