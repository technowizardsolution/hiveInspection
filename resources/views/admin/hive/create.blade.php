...
@section('title') Create Hive | @endsection
        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">Create Hive</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item "><a href="{{url('admin/dashboard')}}">Dashboard</a>
                                </li>
                                <li class="breadcrumb-item active">Create Hive
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Create Hive</h4>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal" id="hiveForm" role="form" action="{{url('admin/hive')}}" method="post" enctype="multipart/form-data" >
                                @csrf                                   
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="mediums" id="mediums" value="@if(isset($hivedata) && $hivedata->mediums){{$hivedata->mediums}}@endif" placeholder="Mediums">
                                            </div>
                                        </div>
