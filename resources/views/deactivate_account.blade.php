...
<head>
  ...
  <title>Base Bites</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="{{ URL::asset('resources/uploads/logo/fav.png')}}" rel="icon">
  <link href="{{URL::asset('resources/common/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
